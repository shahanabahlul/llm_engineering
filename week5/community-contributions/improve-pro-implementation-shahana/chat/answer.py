...
SUMMARIES_PATH = Path(__file__).parent.parent.parent.parent / "summaries"
...
def fetch_context_unranked(question):
    query = embedding_model.encode([question]).tolist()[0]
...
def fetch_context(original_question):
    ...
    reranked = rerank(rewritten_question, chunks)
    reranked = rerank(original_question, reranked[:15])
